...
export default function Header({user}){
    ...
    return <header className="fixed top-0 left-0 right-0 bg-white z-50">
        <div className="border-b">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <div className="flex items-center">
                        <h1 onClick={()=>router.push('/')} className="text-2xl cursor-pointer font-bold font-serif tracking-tighter">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                {
                                    user.isPremiumUser && <DropdownMenuLabel>Premium User</DropdownMenuLabel>
                                }
